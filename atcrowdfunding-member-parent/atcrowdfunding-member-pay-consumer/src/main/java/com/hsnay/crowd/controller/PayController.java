...
import com.hsnay.crowd.config.PayProperties;
...
public class PayController {
    ...
    public String generateOrder(HttpSession session, OrderVO orderVO) throws UnsupportedEncodingException, AlipayApiException {
